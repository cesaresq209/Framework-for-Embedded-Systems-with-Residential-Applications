...
pin_labels:
- {pin_num: F14, pin_signal: GPIO_AD_B0_09, label: LED_PIN, identifier: LED_PIN}
- {pin_num: L6, pin_signal: WAKEUP, label: BUTTON_PIN, identifier: SD_PWREN;BUTTON_PIN}
...
- pin_list:
  - {pin_num: F14, peripheral: GPIO1, signal: 'gpio_io, 09', pin_signal: GPIO_AD_B0_09, direction: OUTPUT, pull_up_down_config: Pull_Down_100K_Ohm, pull_keeper_select: Keeper,
    drive_strength: R0_6, slew_rate: Slow}
  - {pin_num: L6, peripheral: GPIO5, signal: 'gpio_io, 00', pin_signal: WAKEUP, identifier: BUTTON_PIN, direction: INPUT, gpio_interrupt: kGPIO_NoIntmode, pull_up_down_config: Pull_Up_100K_Ohm}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
...
void BOARD_InitPins(void) {
  ...
  /* GPIO configuration of LED_PIN on GPIO_AD_B0_09 (pin F14) */
  ...
  GPIO_PinInit(GPIO1, 9U, &LED_PIN_config);

  /* GPIO configuration of BUTTON_PIN on WAKEUP (pin L6) */
  gpio_pin_config_t BUTTON_PIN_config = {
      .direction = kGPIO_DigitalInput,
      .outputLogic = 0U,
      .interruptMode = kGPIO_NoIntmode
  };
  /* Initialize GPIO functionality on WAKEUP (pin L6) */
  GPIO_PinInit(GPIO5, 0U, &BUTTON_PIN_config);
