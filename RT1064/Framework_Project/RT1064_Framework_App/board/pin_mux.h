...
#define BOARD_INITPINS_LED_PIN_GPIO                                        GPIO1   /*!< GPIO device name: GPIO1 */
#define BOARD_INITPINS_LED_PIN_PORT                                        GPIO1   /*!< PORT device name: GPIO1 */
#define BOARD_INITPINS_LED_PIN_PIN                                            9U   /*!< GPIO1 pin index: 9 */

/* WAKEUP (coord L6), BUTTON_PIN */
#define BOARD_INITPINS_BUTTON_PIN_GPIO                                     GPIO5   /*!< GPIO device name: GPIO5 */
#define BOARD_INITPINS_BUTTON_PIN_PORT                                     GPIO5   /*!< PORT device name: GPIO5 */
#define BOARD_INITPINS_BUTTON_PIN_PIN                                         0U   /*!< GPIO5 pin index: 0 */
...
#define BOARD_INITUSDHCPINS_SD0_VSELECT_PERIPHERAL                        USDHC1   /*!< Device name: USDHC1 */
#define BOARD_INITUSDHCPINS_SD0_VSELECT_SIGNAL                     usdhc_vselect   /*!< USDHC1 signal: usdhc_vselect */
...
#define BOARD_INITQSPIPINS_FlexSPI_DQS_PERIPHERAL                        FLEXSPI   /*!< Device name: FLEXSPI */
#define BOARD_INITQSPIPINS_FlexSPI_DQS_SIGNAL                      FLEXSPI_A_DQS   /*!< FLEXSPI signal: FLEXSPI_A_DQS */
